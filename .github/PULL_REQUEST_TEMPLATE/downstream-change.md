...
See ~/Code/blazenetic/CUSTOMISATION-GUIDE.md for the conflict-risk classification.
-->
...
- [ ] **Does this modify upstream code?** (Prefer additions under `scripts/blazenetic/`,
      `~/Code/blazenetic/`, or `packaging/`.) If yes, explain why isolation wasn't possible:
...
- [ ] Docs under `~/Code/blazenetic/` updated if behaviour or commands changed
